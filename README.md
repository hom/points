...
`rust` 中使用 `tup` 声明元组类型；`Python` 中使用 `tuple` 来声明元组类型；`Go` 中使用 `Pair/Tuple` 来实现对和元组操作；

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc1NTI0NTMzOCwtMTIyNTUzNzM1OCwtMT
